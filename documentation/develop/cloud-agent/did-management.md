...
For mnemonic-based deterministic PRISM DID creation, including derivation path details and test vectors, see [Deterministic PRISM DID Creation](/documentation/develop/deterministic-did-creation).
